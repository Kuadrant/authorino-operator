...
| enableLoggingFields      |          Boolean            | Enables user-defined fields in authorization decision logs.                                                                                                                                                                             | Default: `false`                                      |
| loggingFieldsMaxValueBytes |         Integer            | Maximum size in bytes for each user-defined logging field value. Set to `0` to disable truncation.                                                                                                                                      | Default: Authorino default (`1024`)                   |
