...
| wildcards                | Boolean                     | Enables/disables wildcards ('*') used in host names listed in an [`AuthConfig`](https://github.com/Kuadrant/authorino/blob/main/docs/architecture.md#host-lookup). | Default: `false` (disabled) |
