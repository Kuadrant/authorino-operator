...
const (
	...
	EnvEnableLoggingFields        string = "ENABLE_LOGGING_FIELDS"
	EnvLoggingFieldsMaxValueBytes string = "LOGGING_FIELDS_MAX_VALUE_BYTES"
	...
	FlagEnableLoggingFields            string = "enable-logging-fields"
	FlagLoggingFieldsMaxValueBytes     string = "logging-fields-max-value-bytes"
